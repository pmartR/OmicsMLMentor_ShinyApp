...
#' @param progress_content The content to display in the progress bar.
#' @param placeholder_content The text to display for what file was selected.
...
#' @param placeholder_id The id of a wrapper div around the fileInput widget for purposes of changing the default text.  Defaults to the fileInput widget with js_ prepended.  Set to FALSE to do nothing.
#' 
#' @details
#' 
