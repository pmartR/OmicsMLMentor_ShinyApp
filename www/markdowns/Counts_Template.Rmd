...
`r if (!("Var1" %in% colnames(omicData$f_data))) {paste0("### *Sample data*\nAn associated Sample data file was also uploaded called **", file_fdata_name, "**. Trimmed samples names **", ifelse(pmart_inputs$usevizsampnames == "No", "were not", "were"), "** used. The column in the Sample data file which indicates sample names was designated as **", omicDataAttr$cnames$fdata_cname, "**.")}`
