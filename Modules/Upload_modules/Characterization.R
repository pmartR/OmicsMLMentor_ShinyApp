...
## factor/character report on each predictor
## Predictor Range # NA for categorical
## Predictor Discrete or continuous (counts?) # NA for categorical
## N levels # NA for numbers
## Plot (sparklines package) # Density plot for numeric, Bar plot for categorical
## Estimated distribution? # NA for categorical

## Scale, normalization

## Parent input:
# reactive_dataholder$e_data
# input$e_data_id_col

## Accessible UI via:
# uiOutput("File_upload_module_input_files")
# 
## Please add a static tabset to the UI for previewing data as well!
