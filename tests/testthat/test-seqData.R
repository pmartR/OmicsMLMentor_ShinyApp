...
test_that("RNASeq: Regular, Rewind, All Models", {
  ...
  app$wait_for_idle() #
  app$set_inputs(data_type = "RNA-seq")
  app$wait_for_idle() #
  ...
  app$wait_for_idle() #
  app$set_inputs(datascale = "counts")
  app$wait_for_idle() #
  ...
  app$run_js('$(".confirm").click()')
  app$wait_for_idle() #
  app$set_inputs(pick_model_EM = "hclust")
  app$wait_for_idle() #
  app$click("em_select")
  app$wait_for_idle() #
  app$run_js('$(".confirm").click()')
  ...
  app$run_js('$(".confirm").click()')
  app$wait_for_idle() #
  app$set_inputs(pick_model_EM = "kmeans")
  app$wait_for_idle() #
  app$click("em_select")
  app$wait_for_idle() #
  app$run_js('$(".confirm").click()')
  ...
  app$run_js('$(".confirm").click()')
  app$wait_for_idle() #
  app$set_inputs(pick_model_EM = "pca")
  app$wait_for_idle() #
  app$click("em_select")
  app$wait_for_idle() #
  app$run_js('$(".confirm").click()')
  ...
  app$run_js('$(".confirm").click()')
  app$wait_for_idle() #
  app$set_inputs(pick_model_EM = "ppca")
  app$wait_for_idle() #
  app$click("em_select")
  app$wait_for_idle() #
  app$run_js('$(".confirm").click()')
